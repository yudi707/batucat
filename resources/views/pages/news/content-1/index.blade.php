...
<section id="about" class="outline">
  <div id="cover"></div> {{-- <div id="cover"> --}}
   @section('field', trans('news.news1-title'))
<!--   <h2 class="heading02 lato">
    @yield('field')<br/><i class="fas fa-building"></i>
  </h2>
 -->  @include('pages.news.content-1.breadcrumb')
  <div class="comTtl">
...
<div class="baris">
  <div class="kolom">
    <div class="cardo">
      <h3>{{trans('news.news1-title')}}</h3>
      <!-- <div class="fakeimg" style="height:200px;"></div> -->
      <img src="{{ url('assets/img/news/news-1.jpg') }}">
      <p style="text-align: left;color: #005E48; font-style: italic; font-size: 10px"> 
      Created : Sunday,03-01-2019
      </p>   
      <!--  <span><i class="icon-calender mr-2" style="content:\f073">Narc. 10, 2020</i></span> -->
