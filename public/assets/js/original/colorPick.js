...
(function( $ ) {
    ...
    $.fn.colorPick.defaults = {
        'initialColor': '#3498db',
        'paletteLabel': 'Choose your color:',
        'allowRecent': true,
        'recentMax': 5,
    ...
    $.colorPick.prototype = {
        ...
        show: function(left, top) {
            ...
            $("body").append('<div id="colorPick" style="display:none;top:' + top + 'px;left:' + left + 'px;width: 150px"><span>'+$.fn.colorPick.defaults.paletteLabel+'</span></div>');
